package com.shebut_dev.tele2marketreinvented.data.data_manager.impl.custom_usecases.post;
...
public class PostUserUseCase extends AsyncTask<String, String, String> {
    UseCaseStateCallback stateCallback;
    NetworkHelper helper;
    String result;

    public PostUserUseCase(UseCaseStateCallback callback){
